...
loc = ("C:/Users/andre/Desktop/50.038/project/recent news/recent_china_news.xlsx")
wb = xlrd.open_workbook(loc)
sheet = wb.sheet_by_index(0)

d2v_model= Doc2Vec.load("quarter_sample_d2v/d2v_cn.model")
nRows = sheet.nrows
...
model = pickle.load(open("C:/Users/andre/Desktop/50.038/project/doc2vec tutorial/classification_model_specific/quarter_sample_d2v"
                          "/classification model (cn)/neural_network_multi_layer_perceptron_model.sav", 'rb'))
...
workbook = xlsxwriter.Workbook('recent_china_news_annotated.xlsx')
